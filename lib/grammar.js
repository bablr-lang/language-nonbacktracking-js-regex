...
let _initProto,
  ...
  _GroupDecs,
  _AssertionDecs,
  _StartOfInputAssertionDecs,
  _EndOfInputAssertionDecs,
  _WordBoundaryAssertionDecs,
  _GapDecs,
  _CharacterDecs,
  _CharacterClassDecs,
  _CharacterClassRangeDecs,
  _CharacterSetDecs,
  _AnyCharacterSetDecs,
  _DigitCharacterSetDecs,
  _SpaceCharacterSetDecs,
  _WordCharacterSetDecs,
  _QuantifierDecs,
  _AnyDecs,
  _KeywordDecs,
  _PunctuatorDecs;
              ...
              elements: [
                _t.node(
                  ...
                  [
                    20,
                    [
                      [_t.ref`openToken`, _t.ref`elements[]`, _t.arr(), _t.ref`elements[]`],
                      [
                        _t.ref`elements[]`,
                        _t.ref`elements[]`,
                        _t.ref`elements[]`,
...
export const grammar = class RegexGrammar {
  static {
    [_initProto] = _applyDecs(
      ...
      [
        [Node, 2, 'Pattern'],
        [_FlagsDecs, 2, 'Flags'],
        [AllowEmpty, 2, 'Alternatives'],
        [[AllowEmpty, Node], 2, 'Alternative'],
        [AllowEmpty, 2, 'Elements'],
        [_GroupDecs, 2, 'Group'],
        [Node, 2, 'CapturingGroup'],
        [_AssertionDecs, 2, 'Assertion'],
        [_StartOfInputAssertionDecs, 2, 'StartOfInputAssertion'],
        [_EndOfInputAssertionDecs, 2, 'EndOfInputAssertion'],
        [_WordBoundaryAssertionDecs, 2, 'WordBoundaryAssertion'],
        [_GapDecs, 2, 'Gap'],
        [_CharacterDecs, 2, 'Character'],
        [_CharacterClassDecs, 2, 'CharacterClass'],
        [_CharacterClassRangeDecs, 2, 'CharacterClassRange'],
        [_CharacterSetDecs, 2, 'CharacterSet'],
        [_AnyCharacterSetDecs, 2, 'AnyCharacterSet'],
        [_DigitCharacterSetDecs, 2, 'DigitCharacterSet'],
        [_SpaceCharacterSetDecs, 2, 'SpaceCharacterSet'],
        [_WordCharacterSetDecs, 2, 'WordCharacterSet'],
        [_QuantifierDecs, 2, 'Quantifier'],
  ...
  *[((_FlagsDecs = [UnboundAttributes(Object.keys(flagCharacters)), AllowEmpty, Node]),
  (_GroupDecs = [CoveredBy('Element'), Node]),
  (_AssertionDecs = CoveredBy('Element')),
  (_StartOfInputAssertionDecs = [CoveredBy('Assertion'), Node]),
  (_EndOfInputAssertionDecs = [CoveredBy('Assertion'), Node]),
  (_WordBoundaryAssertionDecs = [UnboundAttributes(['negate']), CoveredBy('Assertion'), Node]),
  (_GapDecs = [CoveredBy('Assertion'), Node]),
  (_CharacterDecs = [CoveredBy('Element'), CoveredBy('CharacterClassElement'), Node]),
  (_CharacterClassDecs = [UnboundAttributes(['negate']), CoveredBy('Element'), Node]),
  (_CharacterClassRangeDecs = [CoveredBy('CharacterClassElement'), Node]),
  (_CharacterSetDecs = CoveredBy('Element')),
  (_AnyCharacterSetDecs = [CoveredBy('CharacterSet'), Node]),
  (_DigitCharacterSetDecs = [UnboundAttributes(['negate']), CoveredBy('CharacterSet'), Node]),
  (_SpaceCharacterSetDecs = [UnboundAttributes(['negate']), CoveredBy('CharacterSet'), Node]),
  (_WordCharacterSetDecs = [UnboundAttributes(['negate']), CoveredBy('CharacterSet'), Node]),
  (_QuantifierDecs = [UnboundAttributes(['min', 'max']), Node]),
  (_AnyDecs = InjectFrom(Shared)),
  (_KeywordDecs = [Node, InjectFrom(Shared)]),
  (_PunctuatorDecs = [Node, InjectFrom(Shared)]),
  'Pattern')]() {
    yield _t.node(
      _l.Instruction,
      'Call',
                            ...
                            [_t.ref`element`, _t.ref`value`],
                            {
                              element: _t.node(
                                ...
                                ],
                                {
                                  openToken: _t.s_node(_l.Regex, 'Punctuator', '['),
                                  elements: [
                                    _t.node(_l.Regex, 'Character', [_t.lit('g')], {}, {}),
                                    _t.node(_l.Regex, 'Character', [_t.lit('i')], {}, {}),
                                    _t.node(_l.Regex, 'Character', [_t.lit('m')], {}, {}),
          ...
          [_t.ref`verb`, _t.ref`arguments`],
          {
            ...
            arguments: _t.node(
              ...
              [
                ...
                [
                  [
                    ...
                    _t.ref`values[]`,
                    _t.arr(),
                    ..._interpolateFragmentChildren(buildString(name), _t.ref`values[]`),
                  ],
                  [
                    _t.ref`separators[]`,
                    _t.arr(),
              ...
              ],
              {
                openToken: _t.s_node(_l.Instruction, 'Punctuator', '('),
                values: [
                  ..._interpolateArray(buildString(name)),
                  _t.node(
                    _l.Instruction,
                    'Boolean',
                    [_t.ref`sigilToken`],
                                      ...
                                      elements: [
                                        ...
                                        _t.node(
                                          ...
                                          ],
                                          {
                                            openToken: _t.s_node(_l.Regex, 'Punctuator', '['),
                                            elements: [
                                              _t.node(_l.Regex, 'Character', [_t.lit('d')], {}, {}),
                                              _t.node(_l.Regex, 'Character', [_t.lit('s')], {}, {}),
                                              _t.node(_l.Regex, 'Character', [_t.lit('w')], {}, {}),
                                              _t.node(_l.Regex, 'Character', [_t.lit('p')], {}, {}),
                                            ],
                                            closeToken: _t.s_node(_l.Regex, 'Punctuator', ']'),
                                          },
                                          {
                        ...
                        open: _t.node(
                          ...
                          ],
                          {
                            ...
                            flags: _t.node(
                              _l.CSTML,
                              'Flags',
                              [_t.ref`tokenToken`, _t.ref`expressionToken`],
                              {
                                tokenToken: _t.s_node(_l.CSTML, 'Punctuator', '*'),
                                expressionToken: _t.s_node(_l.CSTML, 'Punctuator', '+'),
                              },
                        ...
                        open: _t.node(
                          ...
                          ],
                          {
                            ...
                            flags: _t.node(
                              _l.CSTML,
                              'Flags',
                              [_t.ref`tokenToken`, _t.ref`escapeToken`],
                              {
                                tokenToken: _t.s_node(_l.CSTML, 'Punctuator', '*'),
            ...
            [
              ...
              [
                ...
                ..._interpolateFragmentChildren(
                  buildBoolean(ctx.sourceTextFor(m) === 'B'),
                  _t.ref`values[]`,
                ),
                _t.ref`closeToken`,
              ],
          ...
          [
            ...
            [
              ...
              [
                ...
                _t.arr(),
                _t.ref`separators[]`,
                ..._interpolateFragmentChildren(buildBoolean(neg), _t.ref`values[]`),
                _t.ref`closeToken`,
              ],
            ],
          ],
          ...
          [
            ...
            [
              ...
              [
                ...
                _t.ref`separators[]`,
                ..._interpolateFragmentChildren(
                  buildBoolean(ctx.sourceTextFor(code) === 'D'),
                  _t.ref`values[]`,
                ),
                _t.ref`closeToken`,
              ],
          ...
          [
            ...
            [
              ...
              [
                ...
                _t.ref`separators[]`,
                ..._interpolateFragmentChildren(
                  buildBoolean(ctx.sourceTextFor(code) === 'S'),
                  _t.ref`values[]`,
                ),
                _t.ref`closeToken`,
              ],
          ...
          [
            ...
            [
              ...
              [
                ...
                _t.ref`separators[]`,
                ..._interpolateFragmentChildren(
                  buildBoolean(ctx.sourceTextFor(code) === 'W'),
                  _t.ref`values[]`,
                ),
                _t.ref`closeToken`,
              ],
          ...
          [
            ...
            [
              ...
              [
                ...
                _t.ref`separators[]`,
                ..._interpolateFragmentChildren(
                  attrs.min ? buildNumber(attrs.min) : buildNullTag(),
                  _t.ref`values[]`,
                ),
                _t.ref`closeToken`,
              ],
          ...
          [
            ...
            [
              ...
              [
                ...
                _t.ref`separators[]`,
                ..._interpolateFragmentChildren(
                  attrs.max ? buildNumber(attrs.max) : buildNullTag(),
                  _t.ref`values[]`,
                ),
                _t.ref`closeToken`,
              ],
        ...
        [_t.ref`verb`, _t.ref`arguments`],
        {
          ...
          arguments: _t.node(
            ...
            [
              ...
              _t.arr(),
              ..._interpolateFragmentChildren(
                getSpecialPattern(parentSpan, ctx.reifyExpression(props)),
                _t.ref`values[]`,
              ),
              _t.ref`closeToken`,
            ],
            {
              openToken: _t.s_node(_l.Instruction, 'Punctuator', '('),
              values: [
                ..._interpolateArray(getSpecialPattern(parentSpan, ctx.reifyExpression(props))),
              ],
              closeToken: _t.s_node(_l.Instruction, 'Punctuator', ')'),
            },
            {},
                          ...
                          elements: [
                            _t.node(
                              ...
                              ],
                              {
                                ...
                                elements: [
                                  _t.node(_l.Regex, 'Character', [_t.lit('u')], {}, {}),
                                  _t.node(_l.Regex, 'Character', [_t.lit('x')], {}, {}),
                                ],
                                closeToken: _t.s_node(_l.Regex, 'Punctuator', ']'),
                              },
                              {
